...
# python scripts/evaluation/chunkaug_prompt/hqa.py --run "chunkaug_10_qa_20k" --ckpt 1122
python scripts/evaluation/chunkaug_link_prompt/hqa.py --run "chunkaug_10_qa_link_continue_20k" --ckpt 1122
