...
def main():
    ...
    training_args = TrainingArguments(
        output_dir="training_res/compress_chunk_qa_kvlink5_nopadding_multichunk20k_1e-5",
        report_to="wandb",
        run_name=f"compress_chunk_{len(compress_tokens)}_qa_kvlink5_nopadding_multichunk20k_1e-5",
