...
CUDA_VISIBLE_DEVICES=2 python scripts/evaluation/anllm/nq.py --run "training_res/anchor_continue_qa_10k" --ckpt 561 &
CUDA_VISIBLE_DEVICES=3 python scripts/evaluation/anllm/wiki.py --run "training_res/anchor_continue_qa_10k" --ckpt 561 &
CUDA_VISIBLE_DEVICES=4 python scripts/evaluation/anllm_link/hqa.py --run "training_res/anchor_continue_qa_link_10k" --ckpt 561 &
CUDA_VISIBLE_DEVICES=5 python scripts/evaluation/anllm_link/musique.py --run "training_res/anchor_continue_qa_link_10k" --ckpt 561 &
CUDA_VISIBLE_DEVICES=6 python scripts/evaluation/anllm_link/nq.py --run "training_res/anchor_continue_qa_link_10k" --ckpt 561 &
CUDA_VISIBLE_DEVICES=7 python scripts/evaluation/anllm_link/wiki.py --run "training_res/anchor_continue_qa_link_10k" --ckpt 561 &
