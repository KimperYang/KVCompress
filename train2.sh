...
accelerate launch --config_file config/4gpu_step4.yaml --main_process_port 25671 chunkaug_qa_trainer.py --dataset "qa"
accelerate launch --config_file config/4gpu_step4.yaml --main_process_port 25671 chunkaug_qa_trainer.py --dataset "qa_link"
