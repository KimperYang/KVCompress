...
CUDA_VISIBLE_DEVICES=1 python scripts/evaluation/ratio_kvlink_prompt/hqa2_eval.py --run "ratio_compress_qa_kvlink_multichunk20k" --ckpt 1122 &
...
CUDA_VISIBLE_DEVICES=5 python scripts/evaluation/ratio_prompt/hqa2_eval.py --run "ratio_compress_qa_multichunk20k" --ckpt 1122 &
