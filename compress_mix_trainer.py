...
def main():
    ...
    ptr_train, ptr_eval = load_from_disk_then_process("text_multichunk", preprocessor)
    ...
    training_args = TrainingArguments(
        output_dir="training_res/chunkcomp_mix_3k",
        report_to="wandb",
        run_name=f"compress_chunk_{len(compress_tokens)}_mix",
