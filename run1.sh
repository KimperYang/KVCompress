...
CUDA_VISIBLE_DEVICES=2 python scripts/evaluation/chunkaug_prompt/tqa_eval.py --run "chunkaug_qa_20k" --ckpt 1122 &
CUDA_VISIBLE_DEVICES=3 python scripts/evaluation/chunkaug_prompt/wiki_eval.py --run "chunkaug_qa_20k" --ckpt 1122 &
