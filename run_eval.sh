...
CUDA_VISIBLE_DEVICES=4 python scripts/evaluation/ratio_kvlink/tqa_eval.py --run "ratio_compress_qa_link4_multichunk20k" --ckpt 1122 &
CUDA_VISIBLE_DEVICES=1 python scripts/evaluation/ratio_kvlink/hqa2_eval.py --run "ratio_compress_qa_link4_multichunk20k" --ckpt 1122 &
CUDA_VISIBLE_DEVICES=2 python scripts/evaluation/ratio_kvlink/nq2_eval.py --run "ratio_compress_qa_link4_multichunk20k" --ckpt 1122 &
CUDA_VISIBLE_DEVICES=3 python scripts/evaluation/ratio_kvlink/wiki_eval.py --run "ratio_compress_qa_link4_multichunk20k" --ckpt 1122 &
