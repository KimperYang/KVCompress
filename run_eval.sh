...
CUDA_VISIBLE_DEVICES=0 python scripts/evaluation/anllm/nq.py --run "anchor_5_qa_qa_10k" --ckpt 1122  --pos 0 &
...
CUDA_VISIBLE_DEVICES=2 python scripts/evaluation/anllm_link/hqa.py --run "anchor_5_freeze_qa_link_10k" --ckpt 561 --reencode 5  &
...
CUDA_VISIBLE_DEVICES=5 python scripts/evaluation/anllm_link/wiki.py --run "anchor_5_freeze_qa_link_10k" --ckpt 561 --reencode 5  &
