...
CUDA_VISIBLE_DEVICES=4 python scripts/evaluation/chunk_nopadding/tqa_eval.py --run "compress_chunk_qa_nopadding_multichunk20k_epoch2" --ckpt 1122 &
...
CUDA_VISIBLE_DEVICES=2 python scripts/evaluation/chunk_nopadding/nq2_eval.py --run "compress_chunk_qa_nopadding_multichunk20k_epoch2" --ckpt 1122 &
CUDA_VISIBLE_DEVICES=3 python scripts/evaluation/chunk_nopadding/wiki_eval.py --run "compress_chunk_qa_nopadding_multichunk20k_epoch2" --ckpt 1122 &
