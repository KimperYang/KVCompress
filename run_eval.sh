...
CUDA_VISIBLE_DEVICES=0 python scripts/evaluation/chunk_kvlink5/tqa_eval.py --run "compress_chunk_qa_kvlink5_nopadding_multichunk20k_5e-6" --ckpt 1122 &
CUDA_VISIBLE_DEVICES=1 python scripts/evaluation/chunk_kvlink5/hqa2_eval.py --run "compress_chunk_qa_kvlink5_nopadding_multichunk20k_5e-6" --ckpt 1122 &
CUDA_VISIBLE_DEVICES=2 python scripts/evaluation/chunk_kvlink5/nq2_eval.py --run "compress_chunk_qa_kvlink5_nopadding_multichunk20k_5e-6" --ckpt 1122 &
CUDA_VISIBLE_DEVICES=3 python scripts/evaluation/chunk_kvlink5/wiki_eval.py --run "compress_chunk_qa_kvlink5_nopadding_multichunk20k_5e-6" --ckpt 1122 &
CUDA_VISIBLE_DEVICES=4 python scripts/evaluation/chunk_kvlink5/wiki_eval.py --run "compress_chunk_qa_kvlink5_nopadding_multichunk20k_1e-5" --ckpt 1122 &
