...
CUDA_VISIBLE_DEVICES=0 python scripts/evaluation/chunk_nopadding_kvlink5_prompt/tqa_eval.py --run "compress_chunk_qa_kvlink5_nopadding_multichunk20k_1e-5" --ckpt 1122 &
CUDA_VISIBLE_DEVICES=4 python scripts/evaluation/chunk_nopadding_kvlink5_prompt/hqa2_eval.py --run "compress_chunk_qa_kvlink5_nopadding_multichunk20k_1e-5" --ckpt 1122 &
CUDA_VISIBLE_DEVICES=2 python scripts/evaluation/chunk_nopadding_kvlink5_prompt/nq2_eval.py --run "compress_chunk_qa_kvlink5_nopadding_multichunk20k_1e-5" --ckpt 1122 &
CUDA_VISIBLE_DEVICES=3 python scripts/evaluation/chunk_nopadding_kvlink5_prompt/wiki_eval.py --run "compress_chunk_qa_kvlink5_nopadding_multichunk20k_1e-5" --ckpt 1122 &
CUDA_VISIBLE_DEVICES=5 python scripts/evaluation/ratio_kvlink5_prompt/nq2_eval.py --run "ratio_50_compress_qa_kvlink5_multichunk20k_1e-5" --ckpt 1122 &
CUDA_VISIBLE_DEVICES=6 python scripts/evaluation/ratio_kvlink5_prompt/hqa2_eval.py --run "ratio_50_compress_qa_kvlink5_multichunk20k_1e-5" --ckpt 1122 &
wait
