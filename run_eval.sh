...
CUDA_VISIBLE_DEVICES=0 python scripts/evaluation/kvlink/tqa_eval.py --run "block_qa" --ckpt 1122 &
CUDA_VISIBLE_DEVICES=1 python scripts/evaluation/kvlink/hqa2_eval.py --run "block_qa" --ckpt 1122 &
CUDA_VISIBLE_DEVICES=2 python scripts/evaluation/kvlink/nq2_eval.py --run "block_qa" --ckpt 1122 &
CUDA_VISIBLE_DEVICES=3 python scripts/evaluation/kvlink/wiki_eval.py --run "block_qa" --ckpt 1122 &
