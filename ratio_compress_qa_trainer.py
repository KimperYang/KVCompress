...
def main():
    ...
    global_tokenizer = AutoTokenizer.from_pretrained("training_res/ratio_50_compress_multichunk20k_kvlink/checkpoint-20000")
    global_model = AutoModelForCausalLM.from_pretrained(
        "training_res/ratio_50_compress_multichunk20k_kvlink/checkpoint-20000",
    ...
    training_args = TrainingArguments(
        output_dir="training_res/ratio_compress_qa_kvlink_linkchunk20k",
        report_to="wandb",
        run_name=f"ratio_compress_qa_kvlink_{int(len(compress_tokens) * 100)}_linkchunk20k",
